...
class LlagaLlamaForCausalLM(LlamaForCausalLM, LlagaMetaForCausalLM):
    ...
    def forward(
        ...
        if input_ids_desc is not None:
            input_ids_desc, attention_mask_desc, past_key_values, inputs_embeds_desc, labels = self.prepare_inputs_labels_for_multimodal(input_ids_desc, None, past_key_values, labels, graph, graph_emb)
            ...
            inputs_embeds = torch.cat([inputs_embeds, outputs_desc], dim=2)
